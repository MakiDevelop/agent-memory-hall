...
Local CLI dogfooding for Codex (no memhall HTTP / no bearer token):

- [Codex handoff guide](https://github.com/MakiDevelop/agent-memory-hall/blob/main/packages/core/docs/codex-handoff.md)
- [Acceptance briefing](https://github.com/MakiDevelop/agent-memory-hall/blob/main/packages/core/docs/codex-acceptance-briefing.md)
- [Architecture](https://github.com/MakiDevelop/agent-memory-hall/blob/main/packages/core/ARCHITECTURE.md)
